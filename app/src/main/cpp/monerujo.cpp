...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *jvm, void *reserved) {
    ...
    class_TransactionInfo = static_cast<jclass>(jenv->NewGlobalRef(
            jenv->FindClass("com/swap/xwpwallet/model/TransactionInfo")));
    class_Transfer = static_cast<jclass>(jenv->NewGlobalRef(
            jenv->FindClass("com/swap/xwpwallet/model/Transfer")));
    class_WalletListener = static_cast<jclass>(jenv->NewGlobalRef(
            jenv->FindClass("com/swap/xwpwallet/model/WalletListener")));
    class_Ledger = static_cast<jclass>(jenv->NewGlobalRef(
            jenv->FindClass("com/swap/xwpwallet/ledger/Ledger")));
    class_WalletStatus = static_cast<jclass>(jenv->NewGlobalRef(
            jenv->FindClass("com/swap/xwpwallet/model/Wallet$Status")));
...
Java_com_swap_xwpwallet_model_WalletManager_createWalletJ(JNIEnv *env, jobject instance,
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_WalletManager_openWalletJ(JNIEnv *env, jobject instance,
                                                          jstring path, jstring password,
                                                          jint networkType) {
    const char *_path = env->GetStringUTFChars(path, NULL);
    const char *_password = env->GetStringUTFChars(password, NULL);
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_WalletManager_recoveryWalletJ(JNIEnv *env, jobject instance,
                                                              jstring path, jstring password,
                                                              jstring mnemonic,
                                                              jint networkType,
                                                              jlong restoreHeight) {
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_WalletManager_createWalletFromKeysJ(JNIEnv *env, jobject instance,
                                                                    jstring path, jstring password,
                                                                    jstring language,
                                                                    jint networkType,
                                                                    jlong restoreHeight,
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_WalletManager_createWalletFromDeviceJ(JNIEnv *env, jobject instance,
                                                                      jstring path,
                                                                      jstring password,
                                                                      jint networkType,
                                                                      jstring deviceName,
...
Java_com_swap_xwpwallet_model_WalletManager_walletExists(JNIEnv *env, jobject instance,
                                                           jstring path) {
    const char *_path = env->GetStringUTFChars(path, NULL);
    bool exists =
...
JNIEXPORT jboolean JNICALL
Java_com_swap_xwpwallet_model_WalletManager_verifyWalletPassword(JNIEnv *env, jobject instance,
...
Java_com_swap_xwpwallet_model_WalletManager_queryWalletDeviceJ(JNIEnv *env, jobject instance,
                                                                 jstring keys_file_name,
                                                                 jstring password) {
    const char *_keys_file_name = env->GetStringUTFChars(keys_file_name, NULL);
    const char *_password = env->GetStringUTFChars(password, NULL);
...
Java_com_swap_xwpwallet_model_WalletManager_findWallets(JNIEnv *env, jobject instance,
                                                          jstring path) {
    const char *_path = env->GetStringUTFChars(path, NULL);
...
Java_com_swap_xwpwallet_model_WalletManager_setDaemonAddressJ(JNIEnv *env, jobject instance,
                                                                jstring address) {
...
JNIEXPORT jint JNICALL
Java_com_swap_xwpwallet_model_WalletManager_getDaemonVersion(JNIEnv *env,
                                                               jobject instance) {
    uint32_t version;
    bool isConnected =
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_WalletManager_getBlockchainHeight(JNIEnv *env, jobject instance) {
    return Bitmonero::WalletManagerFactory::getWalletManager()->blockchainHeight();
}

JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_WalletManager_getBlockchainTargetHeight(JNIEnv *env,
                                                                        jobject instance) {
    return Bitmonero::WalletManagerFactory::getWalletManager()->blockchainTargetHeight();
}

JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_WalletManager_getNetworkDifficulty(JNIEnv *env, jobject instance) {
    return Bitmonero::WalletManagerFactory::getWalletManager()->networkDifficulty();
}

JNIEXPORT jdouble JNICALL
Java_com_swap_xwpwallet_model_WalletManager_getMiningHashRate(JNIEnv *env, jobject instance) {
    return Bitmonero::WalletManagerFactory::getWalletManager()->miningHashRate();
}

JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_WalletManager_getBlockTarget(JNIEnv *env, jobject instance) {
    return Bitmonero::WalletManagerFactory::getWalletManager()->blockTarget();
}

JNIEXPORT jboolean JNICALL
Java_com_swap_xwpwallet_model_WalletManager_isMining(JNIEnv *env, jobject instance) {
    return static_cast<jboolean>(Bitmonero::WalletManagerFactory::getWalletManager()->isMining());
}

JNIEXPORT jboolean JNICALL
Java_com_swap_xwpwallet_model_WalletManager_startMining(JNIEnv *env, jobject instance,
                                                          jstring address,
...
JNIEXPORT jboolean JNICALL
Java_com_swap_xwpwallet_model_WalletManager_stopMining(JNIEnv *env, jobject instance) {
    return static_cast<jboolean>(Bitmonero::WalletManagerFactory::getWalletManager()->stopMining());
}

JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_WalletManager_resolveOpenAlias(JNIEnv *env, jobject instance,
                                                               jstring address,
...
JNIEXPORT jboolean JNICALL
Java_com_swap_xwpwallet_model_WalletManager_closeJ(JNIEnv *env, jobject instance,
...
JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_Wallet_getSeed(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    return env->NewStringUTF(wallet->seed().c_str());
}

JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_Wallet_getSeedLanguage(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    return env->NewStringUTF(wallet->getSeedLanguage().c_str());
}

JNIEXPORT void JNICALL
Java_com_swap_xwpwallet_model_Wallet_setSeedLanguage(JNIEnv *env, jobject instance,
                                                       jstring language) {
    const char *_language = env->GetStringUTFChars(language, NULL);
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jint JNICALL
Java_com_swap_xwpwallet_model_Wallet_getStatusJ(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jobject JNICALL
Java_com_swap_xwpwallet_model_Wallet_statusWithErrorString(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jboolean JNICALL
Java_com_swap_xwpwallet_model_Wallet_setPassword(JNIEnv *env, jobject instance,
                                                   jstring password) {
    const char *_password = env->GetStringUTFChars(password, NULL);
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_Wallet_getAddressJ(JNIEnv *env, jobject instance,
                                                   jint accountIndex,
                                                   jint addressIndex) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_Wallet_getPath(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    return env->NewStringUTF(wallet->path().c_str());
}

JNIEXPORT jint JNICALL
Java_com_swap_xwpwallet_model_Wallet_nettype(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_Wallet_getIntegratedAddress(JNIEnv *env, jobject instance,
                                                            jstring payment_id) {
...
JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_Wallet_getSecretViewKey(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    return env->NewStringUTF(wallet->secretViewKey().c_str());
}

JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_Wallet_getSecretSpendKey(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    return env->NewStringUTF(wallet->secretSpendKey().c_str());
}

JNIEXPORT jboolean JNICALL
Java_com_swap_xwpwallet_model_Wallet_store(JNIEnv *env, jobject instance,
                                             jstring path) {
    const char *_path = env->GetStringUTFChars(path, NULL);
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_Wallet_getFilename(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jboolean JNICALL
Java_com_swap_xwpwallet_model_Wallet_initJ(JNIEnv *env, jobject instance,
...
JNIEXPORT void JNICALL
Java_com_swap_xwpwallet_model_Wallet_setRestoreHeight(JNIEnv *env, jobject instance,
                                                        jlong height) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_getRestoreHeight(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jint JNICALL
Java_com_swap_xwpwallet_model_Wallet_getConnectionStatusJ(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_getBalance(JNIEnv *env, jobject instance,
                                                  jint accountIndex) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_getBalanceAll(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    return wallet->balanceAll();
}

JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_getUnlockedBalance(JNIEnv *env, jobject instance,
                                                          jint accountIndex) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_getUnlockedBalanceAll(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    return wallet->unlockedBalanceAll();
}

JNIEXPORT jboolean JNICALL
Java_com_swap_xwpwallet_model_Wallet_isWatchOnly(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    return static_cast<jboolean>(wallet->watchOnly());
}

JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_getBlockChainHeight(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    return wallet->blockChainHeight();
}

JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_getApproximateBlockChainHeight(JNIEnv *env,
                                                                      jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_getDaemonBlockChainHeight(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    return wallet->daemonBlockChainHeight();
}

JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_getDaemonBlockChainTargetHeight(JNIEnv *env,
                                                                       jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jboolean JNICALL
Java_com_swap_xwpwallet_model_Wallet_isSynchronized(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    return static_cast<jboolean>(wallet->synchronized());
}

JNIEXPORT jint JNICALL
Java_com_swap_xwpwallet_model_Wallet_getDeviceTypeJ(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
Java_com_swap_xwpwallet_util_KeyStoreHelper_slowHash(JNIEnv *env, jclass clazz,
...
JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_Wallet_getDisplayAmount(JNIEnv *env, jclass clazz,
                                                        jlong amount) {
    return env->NewStringUTF(Bitmonero::Wallet::displayAmount(amount).c_str());
}

JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_getAmountFromString(JNIEnv *env, jclass clazz,
                                                           jstring amount) {
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_getAmountFromDouble(JNIEnv *env, jclass clazz,
                                                           jdouble amount) {
    return Bitmonero::Wallet::amountFromDouble(amount);
}

JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_Wallet_generatePaymentId(JNIEnv *env, jclass clazz) {
    return env->NewStringUTF(Bitmonero::Wallet::genPaymentId().c_str());
}

JNIEXPORT jboolean JNICALL
Java_com_swap_xwpwallet_model_Wallet_isPaymentIdValid(JNIEnv *env, jclass clazz,
                                                        jstring payment_id) {
    const char *_payment_id = env->GetStringUTFChars(payment_id, NULL);
...
JNIEXPORT jboolean JNICALL
Java_com_swap_xwpwallet_model_Wallet_isAddressValid(JNIEnv *env, jclass clazz,
...
JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_Wallet_getPaymentIdFromAddress(JNIEnv *env, jclass clazz,
                                                               jstring address,
                                                               jint networkType) {
    Monero::NetworkType _networkType = static_cast<Monero::NetworkType>(networkType);
    const char *_address = env->GetStringUTFChars(address, NULL);
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_getMaximumAllowedAmount(JNIEnv *env, jclass clazz) {
    return Bitmonero::Wallet::maximumAllowedAmount();
}

JNIEXPORT void JNICALL
Java_com_swap_xwpwallet_model_Wallet_startRefresh(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    wallet->startRefresh();
}

JNIEXPORT void JNICALL
Java_com_swap_xwpwallet_model_Wallet_pauseRefresh(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    wallet->pauseRefresh();
}

JNIEXPORT jboolean JNICALL
Java_com_swap_xwpwallet_model_Wallet_refresh(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    return static_cast<jboolean>(wallet->refresh());
}

JNIEXPORT void JNICALL
Java_com_swap_xwpwallet_model_Wallet_refreshAsync(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    wallet->refreshAsync();
}
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_createTransactionJ(JNIEnv *env, jobject instance,
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_createSweepTransaction(JNIEnv *env, jobject instance,
                                                              jstring dst_addr, jstring payment_id,
                                                              jint mixin_count,
                                                              jint priority,
                                                              jint accountIndex) {
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_createSweepUnmixableTransactionJ(JNIEnv *env,
                                                                        jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT void JNICALL
Java_com_swap_xwpwallet_model_Wallet_disposeTransaction(JNIEnv *env, jobject instance,
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_getHistoryJ(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_Wallet_setListenerJ(JNIEnv *env, jobject instance,
...
JNIEXPORT jint JNICALL
Java_com_swap_xwpwallet_model_Wallet_getDefaultMixin(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    return wallet->defaultMixin();
}

JNIEXPORT void JNICALL
Java_com_swap_xwpwallet_model_Wallet_setDefaultMixin(JNIEnv *env, jobject instance, jint mixin) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
    return wallet->setDefaultMixin(mixin);
}

JNIEXPORT jboolean JNICALL
Java_com_swap_xwpwallet_model_Wallet_setUserNote(JNIEnv *env, jobject instance,
...
JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_Wallet_getUserNote(JNIEnv *env, jobject instance,
                                                   jstring txid) {
...
JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_Wallet_getTxKey(JNIEnv *env, jobject instance,
                                                jstring txid) {
...
JNIEXPORT void JNICALL
Java_com_swap_xwpwallet_model_Wallet_addAccount(JNIEnv *env, jobject instance,
                                                  jstring label) {
...
JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_Wallet_getSubaddressLabel(JNIEnv *env, jobject instance,
...
JNIEXPORT void JNICALL
Java_com_swap_xwpwallet_model_Wallet_setSubaddressLabel(JNIEnv *env, jobject instance,
                                                          jint accountIndex, jint addressIndex,
                                                          jstring label) {
...
JNIEXPORT jint JNICALL
Java_com_swap_xwpwallet_model_Wallet_getNumAccounts(JNIEnv *env, jobject instance) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT jint JNICALL
Java_com_swap_xwpwallet_model_Wallet_getNumSubaddresses(JNIEnv *env, jobject instance,
                                                          jint accountIndex) {
    Bitmonero::Wallet *wallet = getHandle<Bitmonero::Wallet>(env, instance);
...
JNIEXPORT void JNICALL
Java_com_swap_xwpwallet_model_Wallet_addSubaddress(JNIEnv *env, jobject instance,
                                                     jint accountIndex,
                                                     jstring label) {
...
/*JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_Wallet_getLastSubaddress(JNIEnv *env, jobject instance,
                                                         jint accountIndex) {
...
// TransactionHistory
JNIEXPORT jint JNICALL
Java_com_swap_xwpwallet_model_TransactionHistory_getCount(JNIEnv *env, jobject instance) {
...
JNIEXPORT jobject JNICALL
Java_com_swap_xwpwallet_model_TransactionHistory_refreshJ(JNIEnv *env, jobject instance) {
    Bitmonero::TransactionHistory *history = getHandle<Bitmonero::TransactionHistory>(env,
                                                                                      instance);
    history->refresh();
...
JNIEXPORT jint JNICALL
Java_com_swap_xwpwallet_model_PendingTransaction_getStatusJ(JNIEnv *env, jobject instance) {
    Bitmonero::PendingTransaction *tx = getHandle<Bitmonero::PendingTransaction>(env, instance);
    return tx->status();
}

JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_PendingTransaction_getErrorString(JNIEnv *env, jobject instance) {
    Bitmonero::PendingTransaction *tx = getHandle<Bitmonero::PendingTransaction>(env, instance);
...
JNIEXPORT jboolean JNICALL
Java_com_swap_xwpwallet_model_PendingTransaction_commit(JNIEnv *env, jobject instance,
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_PendingTransaction_getAmount(JNIEnv *env, jobject instance) {
    Bitmonero::PendingTransaction *tx = getHandle<Bitmonero::PendingTransaction>(env, instance);
    return tx->amount();
}

JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_PendingTransaction_getDust(JNIEnv *env, jobject instance) {
    Bitmonero::PendingTransaction *tx = getHandle<Bitmonero::PendingTransaction>(env, instance);
    return tx->dust();
}

JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_PendingTransaction_getFee(JNIEnv *env, jobject instance) {
    Bitmonero::PendingTransaction *tx = getHandle<Bitmonero::PendingTransaction>(env, instance);
    return tx->fee();
}
...
JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_PendingTransaction_getFirstTxIdJ(JNIEnv *env, jobject instance) {
    Bitmonero::PendingTransaction *tx = getHandle<Bitmonero::PendingTransaction>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_swap_xwpwallet_model_PendingTransaction_getTxCount(JNIEnv *env, jobject instance) {
    Bitmonero::PendingTransaction *tx = getHandle<Bitmonero::PendingTransaction>(env, instance);
    return tx->txCount();
}
...
JNIEXPORT void JNICALL
Java_com_swap_xwpwallet_model_WalletManager_initLogger(JNIEnv *env, jclass clazz,
                                                         jstring argv0,
...
JNIEXPORT void JNICALL
Java_com_swap_xwpwallet_model_WalletManager_logDebug(JNIEnv *env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_com_swap_xwpwallet_model_WalletManager_logInfo(JNIEnv *env, jclass clazz,
                                                      jstring category, jstring message) {
...
JNIEXPORT void JNICALL
Java_com_swap_xwpwallet_model_WalletManager_logWarning(JNIEnv *env, jclass clazz,
                                                         jstring category, jstring message) {
...
JNIEXPORT void JNICALL
Java_com_swap_xwpwallet_model_WalletManager_logError(JNIEnv *env, jclass clazz,
                                                       jstring category, jstring message) {
...
JNIEXPORT void JNICALL
Java_com_swap_xwpwallet_model_WalletManager_setLogLevel(JNIEnv *env, jclass clazz,
                                                          jint level) {
    Bitmonero::WalletManagerFactory::setLogLevel(level);
}

JNIEXPORT jstring JNICALL
Java_com_swap_xwpwallet_model_WalletManager_moneroVersion(JNIEnv *env, jclass clazz) {
