...
package com.cryptocoin.levin.scanner;

import com.cryptocoin.levin.data.Bucket;
import com.cryptocoin.levin.data.Section;
import com.cryptocoin.levin.util.HexHelper;
import com.cryptocoin.levin.util.LittleEndianDataInputStream;
import com.cryptocoin.levin.util.LittleEndianDataOutputStream;
...
public class PeerRetriever implements Callable<PeerRetriever> {
    ...
    static private Section handshakeRequest() {
        ...
        byte[] networkId = Helper.hexToBytes("45f87aded79b1f611731008216A1A110"); // cryptocoin mainnet network id
        ...
        byte[] genesisHash =
                Helper.hexToBytes("4b49042122496cc7e94d392b29bd12ebbc92bcec98990470a30c1eb323b41ebb");
