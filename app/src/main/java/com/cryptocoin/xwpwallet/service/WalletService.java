...
package com.cryptocoin.cryptowallet.service;
...
import com.cryptocoin.cryptowallet.model.WalletListener;
...
public class WalletService extends Service {
    ...
    private static final long STATUS_UPDATE_INTERVAL = 15000; // cryptocoin 15s (blocktime)
    ...
    private void startNotfication() {
        ...
        Notification notification = new NotificationCompat.Builder(this, channelId)
                ...
                .setOngoing(true)
                .setSmallIcon(R.drawable.ic_cryptocoin)
