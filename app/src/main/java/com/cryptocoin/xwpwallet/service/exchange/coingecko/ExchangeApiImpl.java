...
package com.cryptocoin.cryptowallet.service.exchange.coingecko;
...
public class ExchangeApiImpl implements ExchangeApi {
    static final String CRYPTO_ID = "cryptocoin";
    ...
    public void queryExchangeRate(@NonNull final String baseCurrency, @NonNull final String quoteCurrency,
        ...
        final boolean cryptocoinAssets = inverse;

        final HttpUrl url = baseUrl.newBuilder()
                .addQueryParameter("ids", "cryptocoin")
            ...
            public void onResponse(final Call call, final Response response) throws IOException {
                if (response.isSuccessful()) {
                    try {
                        ...
                        final JSONObject jsonResult = json.getJSONObject("cryptocoin");
                        reportSuccess(jsonResult, cryptocoinAssets, callback);
    ...
    void reportSuccess(JSONObject jsonObject, boolean cryptocoinAssets, ExchangeCallback callback) {
        try {
            final ExchangeRate exchangeRate = new ExchangeRateImpl(jsonObject, cryptocoinAssets);
